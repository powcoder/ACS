...
//	@Test
//	public static void testgetBooksInDemandforzero () throws BookStoreException {
//		List<StockBook> booksInDemand = storeManager.getBooksInDemand();
//	 	assertTrue(booksInDemand.size() == 0);
//	} 
//  
//	@Test
//	public static void testgetBooksInDemandforone() throws BookStoreException {
//		Set<BookCopy> booksToBuy= new HashSet<BookCopy>();
//		booksToBuy.add(new BookCopy(TEST_ISBN, NUM_COPIES+1)); 
//		try{ 
//			client.buyBooks(booksToBuy); 
...
//	}
	...
	public void testInvalidRate() throws BookStoreException {
		BookRating rate = new BookRating(TEST_ISBN, -1);
		HashSet<BookRating> rateSet = new HashSet<>();
		HashSet<BookRating> rateSet1 = rateSet;
		rateSet.add(rate);
		try {
			client.rateBooks(rateSet);
			fail();
		} catch (BookStoreException ex) {
			;
		}
		HashSet<BookRating> rateSet2 = rateSet;
		assertTrue(rateSet1 == rateSet2);
	}
	
	@Test
	public void testGetTopRatedBooks() throws BookStoreException {
		BookRating rate1 = new BookRating(TEST_ISBN, 5);
		BookRating rate2 = new BookRating(TEST_ISBN + 1, 1);
		HashSet<BookRating> rateSet = new HashSet<>();
		rateSet.add(rate1);
		rateSet.add(rate2);
